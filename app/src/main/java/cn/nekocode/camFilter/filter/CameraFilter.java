 ...
 */
package cn.nekocode.camFilter.filter;
...
import cn.nekocode.camFilter.MainActivity;
import cn.nekocode.camFilter.MyGLUtils;
import cn.nekocode.camFilter.R;
import cn.nekocode.camFilter.RenderBuffer;
...
public abstract class CameraFilter {
    ...
    static final float TEXTURE_COORDS_front[] = {
            1.0f, 1.0f,
            0.0f, 1.0f,
            1.0f, 0.0f,
            0.0f, 0.0f,
    };
    static FloatBuffer VERTEX_BUF, TEXTURE_COORD_BUF, TEXTURE_COORD_BUF_FRONT;
    ...
    private static FloatBuffer ROATED_TEXTURE_COORD_BUF_FRONT;
    ...
    public CameraFilter(Context context) {
        ...
        if (ROATED_TEXTURE_COORD_BUF_FRONT == null) {
            ROATED_TEXTURE_COORD_BUF_FRONT = ByteBuffer.allocateDirect(ROATED_TEXTURE_COORDS_Front.length * 4)
                    .order(ByteOrder.nativeOrder()).asFloatBuffer();
            ROATED_TEXTURE_COORD_BUF_FRONT.put(ROATED_TEXTURE_COORDS_Front);
            ROATED_TEXTURE_COORD_BUF_FRONT.position(0);
        }
...
//            } else {
//                GLES20.glVertexAttribPointer(vTexCoordLocation, 2, GLES20.GL_FLOAT, false, 4 * 2, ROATED_TEXTURE_COORD_BUF_FRONT);
//            }
